...
sections:
  - block: markdown
    ...
    content:
      ...
      #subtitle: "Beyond Algorithms: A Workshop on the Interdisciplinarity of Recommender Systems"
      text: |-
    ...
    design:
      background:
        image:
          filename: 'header_2025_FallDowntown_MississippiRiver_CREDIT_OmarGhrayeb@OGEEVISUALS_CourtesyOfMeetMinneapolis.jpg'
          filters:
            brightness: 0.5
          position: center
          parallax: true
    ...
    content:
      ...
      text: |- 
          ...
          **We explicitly welcome contributions from outside core computing as well as work that bridges computational and non-computational approaches.**
          ...
          We solicit position papers, research papers, and case study papers of six to ten (6–10) pages (not including references, acknowledgments, and CEUR's Declaration on Generative AI).
          Submissions must use the CEURART single-column template, available for download here (ZIP) or via Overleaf, and be submitted in PDF format.
          ...
          Papers must be submitted via [EasyChair](https://easychair.org/my/conference?conf=recsys2026workshops). Make sure to select the “BEYOND - A Workshop on the Interdisciplinarity of Recommender Systems” track when creating a submission.  
